...
# reload dataset
adata = sc.read_h5ad('/home/users/yliu/projects/scRNA/Kenny_v2/tables/combined.mg_my_data.h5ad')
...
scv.pl.proportions(adata, groupby='celltype_full', save='_mg.pdf')
...
scv.pl.velocity_embedding_grid(adata, basis='umap', color='seurat_clusters', save='mg_dynamic_embedding_grid_umap.pdf', title='', scale=0.25)
scv.pl.velocity_embedding_stream(adata, basis='umap', color='seurat_clusters', save='mg_dynamic_embedding_stream_umap.pdf', title='')
